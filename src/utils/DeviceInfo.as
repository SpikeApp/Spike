package utils
{
	...
	public class DeviceInfo
	{
		...
		public static const IPHONE_X_Xs:String = "iPhoneX_Xs";
		...
		public static function getDeviceType():String
		{
			if (deviceType == null)
			{
				if(Capabilities.cpuArchitecture == "ARM") 
				{
					...
					else if (deviceSpecs.indexOf("iPhone10,3") != -1 || deviceSpecs.indexOf("iPhone10,6") != -1 || deviceSpecs.indexOf("iPhone11,2") != -1)
		...
		public static function getFontMultipier():Number
		{
			...
			else if (deviceType == IPHONE_X_Xs)
		...
		public static function getVerticalPaddingMultipier():Number
		{
			...
			else if (deviceType == IPHONE_6PLUS_6SPLUS_7PLUS_8PLUS || deviceType == IPHONE_X_Xs)
				paddingMultiplier = 2.8;
			else if (deviceType == IPAD_1_2_3_4_5_AIR1_2_PRO_97)
				paddingMultiplier = 3.6;
			else if (deviceType == IPAD_PRO_105 || deviceType == IPAD_PRO_129)
				paddingMultiplier = 4.2;
			else if (deviceType == IPAD_MINI_1_2_3_4 || deviceType == IPHONE_X_Xs)
				paddingMultiplier = 3;
			else
				paddingMultiplier = 2.5;
