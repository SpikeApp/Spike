package ui.screens.display.settings.general
{
	...
	public class LanguageSettingsList extends SpikeList 
	{
		...
		private function setupContent():void
		{
			...
			var appLanguageLabelsList:Array = "Arabic,Bulgarian,简体中文,Czech,Dansk,Dutch,English,Español,Finnish,Français,Deutsch,Hungarian,Italiano,Norsk,Polski,Português,Русский,Svenska".split(",");
			var appLanguageCodesList:Array = "ar_SA,bg_BG,zh_CN,cs_CZ,da_DK,nl_NL,en_US,es_ES,fi_FI,fr_FR,de_DE,hu_HU,it_IT,no_NO,pl_PL,pt_PT,ru_RU,sv_SE".split(",");
