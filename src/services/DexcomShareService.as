	...
	public class DexcomShareService extends EventDispatcher
	{
		...
		public static function testDexcomShareCredentials(externalCall:Boolean = false):void
		{
			...
			else
			{
				...
				(
					Constants.deviceModel != DeviceInfo.IPHONE_X_Xs ? ModelLocator.resourceManagerInstance.getString("dexcomshareservice","credential_test_alert_title") : ModelLocator.resourceManagerInstance.getString("dexcomshareservice","credential_test_alert_title_x"),
