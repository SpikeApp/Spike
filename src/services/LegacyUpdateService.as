package services
{
	...
	public class LegacyUpdateService extends EventDispatcher
	{
		//Instance
		private static var _instance:LegacyUpdateService = new LegacyUpdateService();
		...
		public function LegacyUpdateService(target:IEventDispatcher=null)
		{
			if (_instance != null) {
		...
		//Getters/Setters
		public static function get instance():LegacyUpdateService {
			return _instance;
		}
