package database
{
	 ...
	 public class LocalSettings extends EventDispatcher
	{
		...
		public static const LOCAL_SETTING_MIAOMIAO_MULTIPLE_DEVICE_ON:int = 113;
		public static const LOCAL_SETTING_MIAOMIAO_FOLLOWER_ENABLED:int=114;
		...
		private static var localSettings:Array = [
			...
			"true",//LOCAL_SETTING_MIAOMIAO_MULTIPLE_DEVICE_ON
			"true"//LOCAL_SETTING_MIAOMIAO_FOLLOWER_ENABLED
		];
