package database
{
	 ...
	 public class LocalSettings extends EventDispatcher
	{
		 ...
		 */
		public static const LOCAL_SETTING_APP_CENTER_UPDATER_QUIET_TIME_ENABLED:int=131;
		public static const LOCAL_SETTING_APP_CENTER_UPDATER_QUIET_TIME_START_HOUR:int=132;
		public static const LOCAL_SETTING_APP_CENTER_UPDATER_QUIET_TIME_START_MINUTES:int=133;
		public static const LOCAL_SETTING_APP_CENTER_UPDATER_QUIET_TIME_END_HOUR:int=134;
		public static const LOCAL_SETTING_APP_CENTER_UPDATER_QUIET_TIME_END_MINUTES:int=135;
