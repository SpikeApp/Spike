package database
{
	 ...
	 public class LocalSettings extends EventDispatcher
	{
		 ...
		 */
		public static const LOCAL_SETTING_SPIKE_UPDATER_QUIET_TIME_ENABLED:int=132;
		public static const LOCAL_SETTING_SPIKE_UPDATER_QUIET_TIME_START_HOUR:int=133;
		public static const LOCAL_SETTING_SPIKE_UPDATER_QUIET_TIME_START_MINUTES:int=134;
		public static const LOCAL_SETTING_SPIKE_UPDATER_QUIET_TIME_END_HOUR:int=135;
		public static const LOCAL_SETTING_SPIKE_UPDATER_QUIET_TIME_END_MINUTES:int=136;
		 ...
		 */
		public static const LOCAL_SETTING_CERTIFICATE_NOTIFICATION_EXPIRED:int = 165;
		public static const LOCAL_SETTING_CERTIFICATE_NOTIFICATION_CRITICAL:int = 166;
		public static const LOCAL_SETTING_CERTIFICATE_NOTIFICATION_WARNING:int = 167;
		public static const LOCAL_SETTING_CERTIFICATE_NOTIFICATION_ALERT:int = 168;
		public static const LOCAL_SETTING_CERTIFICATE_NOTIFICATION_REMINDER_1:int = 169;
		public static const LOCAL_SETTING_CERTIFICATE_NOTIFICATION_REMINDER_2:int = 170;
		
		/**
		 * Calibration
		 */
		public static const LOCAL_SETTING_NON_FIXED_LIBRE_CALIBRATION_PARAMETERS:int = 171;
		...
		private static var localSettings:Array = [
			...
			"", //LOCAL_SETTING_CERTIFICATE_NOTIFICATION_EXPIRED
			"", //LOCAL_SETTING_CERTIFICATE_NOTIFICATION_CRITICAL
			"", //LOCAL_SETTING_CERTIFICATE_NOTIFICATION_WARNING
			"", //LOCAL_SETTING_CERTIFICATE_NOTIFICATION_ALERT
			"", //LOCAL_SETTING_CERTIFICATE_NOTIFICATION_REMINDER_1
			"", //LOCAL_SETTING_CERTIFICATE_NOTIFICATION_REMINDER_2
			"false", //LOCAL_SETTING_NON_FIXED_LIBRE_CALIBRATION_PARAMETERS
		];
