...
package database
{
	 ...
	 public class LocalSettings extends EventDispatcher
	{
		 ...
		 * Apple Watch#3
		 */
		public static const LOCAL_SETTING_WATCH_COMPLICATION_DISPLAY_IOB_ON:int = 74;
		public static const LOCAL_SETTING_WATCH_COMPLICATION_DISPLAY_COB_ON:int = 75;
		
		/**
		 * IFTTT #2
		 */
		public static const LOCAL_SETTING_IFTTT_BOLUS_ADDED_ON:int = 76;
		public static const LOCAL_SETTING_IFTTT_BOLUS_UPDATED_ON:int = 77;
		public static const LOCAL_SETTING_IFTTT_BOLUS_DELETED_ON:int = 78;
		public static const LOCAL_SETTING_IFTTT_CARBS_ADDED_ON:int = 79;
		public static const LOCAL_SETTING_IFTTT_CARBS_UPDATED_ON:int = 80;
		public static const LOCAL_SETTING_IFTTT_CARBS_DELETED_ON:int = 81;
		public static const LOCAL_SETTING_IFTTT_MEAL_ADDED_ON:int = 82;
		public static const LOCAL_SETTING_IFTTT_MEAL_UPDATED_ON:int = 83;
		public static const LOCAL_SETTING_IFTTT_MEAL_DELETED_ON:int = 84;
		public static const LOCAL_SETTING_IFTTT_BGCHECK_ADDED_ON:int = 85;
		public static const LOCAL_SETTING_IFTTT_BGCHECK_UPDATED_ON:int = 86;
		public static const LOCAL_SETTING_IFTTT_BGCHECK_DELETED_ON:int = 87;
		public static const LOCAL_SETTING_IFTTT_NOTE_ADDED_ON:int = 88;
		public static const LOCAL_SETTING_IFTTT_NOTE_UPDATED_ON:int = 89;
		public static const LOCAL_SETTING_IFTTT_NOTE_DELETED_ON:int = 90;
		public static const LOCAL_SETTING_IFTTT_IOB_UPDATED_ON:int = 91;
		public static const LOCAL_SETTING_IFTTT_COB_UPDATED_ON:int = 92;
